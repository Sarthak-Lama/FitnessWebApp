...
<aside class="sidebar" id="sidebar">
  ...
  <nav class="sidebar-nav">
    ...
    <a class="nav-item" href="/workout-tracker.html" data-page="workout-tracker.html">
      <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M6 4v16"/><path d="M18 4v16"/><path d="M2 9h4"/><path d="M18 9h4"/><path d="M2 15h4"/><path d="M18 15h4"/></svg>
      Workout Tracker
    </a>
    ...
    <a class="nav-item" href="/calorie-summary.html" data-page="calorie-summary.html">
